...
namespace SQLDOMParser
{
    public class SqlWrapRepository : SqlRepository
    {
        ...
        public override object? GetMethodType(
            ...
            ISyntaxNode node,
            ref string name,
            ref System.Drawing.Point position,
            ref System.Drawing.Point endPos,
            out int paramIndex,
            out int paramCount,
        ...
        public override void FillMembers(ISyntaxNode node, System.Drawing.Point position, IListMembers members, object member, string name, CodeCompletionScope scope, ref int selIndex)
        {
        ...
        public override void LoadDataFromXml(string url)
        {
        ...
        {
            if (LoadImagesFunc == null)
                return;
            var assembly = typeof(NETRepository).Assembly;
            LoadImagesFunc(assembly, $"Alternet.Syntax.Parsers.Advanced.Images.DotNetImagesAlpha{ImagesResourceNameSuffix}.png");
            LoadImagesFunc(assembly, $"Alternet.Syntax.Parsers.Advanced.Images.DotNetImagesAlpha{ImagesResourceNameSuffix}.png");
        }
        ...
        private bool GetQualifiedName(string text, ref string name, ref System.Drawing.Point position)
        {
            name = string.Empty;
            if (text == null)
                return false;
            ...
            position = new System.Drawing.Point(start, position.Y);
            if (end > start)
        ...
        private ISyntaxNode? GetInvocationNode(string text, ISyntaxNode node, System.Drawing.Point position, out int paramIndex, out int paramCount)
        {
            paramIndex = -1;
            paramCount = 0;
            while (node != null)
                        ...
                        !(text != null && position.X > 0 && position.X <= text.Length && text[position.X - 1] == ')'))
                    {
                        ...
                        if (node.HasChildren)
                        {
                            ...
                            if ((exprNode != null) && exprNode.HasChildren && (exprNode.NodeType == (int)MsSqlNodeType.ExpressionList))
                            {
                                ...
                                {
                                    System.Drawing.Point pt = child.Range.EndPoint;
