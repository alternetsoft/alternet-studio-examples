...
{
    public partial class JSONParserWithSchema : JSONParser
    {
        ...
        private Alternet.Common.IRange FindRange(string line, System.Drawing.Point point)
        {
            int start = point.X;
            ...
            return new Alternet.Common.Range(new System.Drawing.Point(start, point.Y), new System.Drawing.Point(end, point.Y));
        }
        ...
        private SyntaxError GetError(ValidationError input)
        {
            ...
            var error = new SyntaxError(new System.Drawing.Point(characterIndex, lineIndex), string.Empty, input.ToString()) { ErrorType = SyntaxErrorType.Warning };
