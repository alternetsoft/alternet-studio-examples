...
namespace TemplateParser
{
    public partial class Form1 : Form
    {
        ...
        private PythonNETParser pythonParser = new PythonTemplateParser();
        ...
        public Form1()
        {
            ...
            var prefix = "TemplateParser.Resources";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            FileInfo fileInfo = new FileInfo(dir + @"Resources\Editor\text\ScriptTemplate.py");
            if (fileInfo.Exists)
            {
