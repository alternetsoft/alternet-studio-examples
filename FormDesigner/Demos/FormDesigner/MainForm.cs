...
namespace Alternet.FormDesigner.Demo
{
    public partial class MainForm : Form
    {
        ...
        {
            var directory = Path.Combine(Path.GetTempPath(), "Alternet.FormDesigner.Demo", "dotnet-" + Environment.Version.ToString(2));
        ...
        {
            string subdirectory = @"Resources\Designer\WinForms";
#if NETCOREAPP
        ...
        private TabPage OpenCode(string formId, string fileName)
        {
            ...
            AddDesignerReferencesToEditor(editor, formId);
            UpdateEditorCommandsState();
            return page;
        }
        ...
        {
            var source = GetDesignerSource(formId);
            var references = GetReferencedAssemblies(source);
        ...
        private void OpenDesigner(string fileName)
        {
            ...
            designer.ViewCodeRequested += Designer_ViewCode;
        ...
        private void Designer_ComponentAdded(object sender, System.ComponentModel.Design.ComponentEventArgs e)
        {
            FormDesignerControl designer = sender as FormDesignerControl;

            if (designer != null)
            {
                var references = designer.ReferencedAssemblies.AssemblyNames;
        ...
        private void Designer_ViewCode(object sender, EventArgs e)
        {
        ...
        private void Designer_ShowPropertiesRequested(object sender, EventArgs e)
        {
            ...
            {
                leftTabControl.SelectTab(propertiesTabPage);
            }
        }
        ...
        private void CreateNewForm()
        {
            ...
            {
                Filter = "C# Files|*.cs|VB.NET Files|*.vb|All Files|*.*",
                FileName = "Form1.cs",
