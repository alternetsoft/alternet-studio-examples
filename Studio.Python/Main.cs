...
namespace AlternetStudio.Demo
{
    public partial class MainForm : Form
    {
        ...
        private static Image LoadImage(string imageName)
        {
            Func<string, Image> getImage = name => Image.FromStream(
                typeof(MainForm).Assembly.GetManifestResourceStream(
                    string.Format("AlternetStudio.Demo.Python.Resources.{0}.png", name)));
        ...
        private void GetDisplayFilesForProject(IList<string> displayFiles, PythonProject project, IList<string> files)
        {
