...
namespace AlternetStudio.Demo
{
    public partial class MainForm
    {
        ...
        private PythonProject GetProject(TreeNode node)
        {
            while (node != null)
            {
                if ((node.Tag != null) && (node.Tag is PythonProject))
                    return node.Tag as PythonProject;
                node = node.Parent;
            }
        ...
        private PythonProject GetProject(string fileName)
        {
        ...
        private void NewProjectMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (var dlg = new DlgNewProject(projectCreationData, new string[] { "Python" }, new string[] { "BlankProject", "ConsoleApp", "WindowsApp" }))
            {
