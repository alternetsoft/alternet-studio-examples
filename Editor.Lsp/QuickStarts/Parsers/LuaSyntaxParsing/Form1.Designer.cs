namespace LspMultipleFiles
{
    ...
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.luaParser = new Alternet.Syntax.Parsers.Lsp.Lua.Embedded.LuaParserEmbedded(this.components);
            ...
            this.btLoad.Location = new System.Drawing.Point(539, 60);
            ...
            this.laDescription.Text = "This demo shows how to use LSP parser for Lua language based on Lua Language Serv" +
    "er. This parser supports automatic code completion and syntax error underlining." +
    "";
        ...
        private Alternet.Syntax.Parsers.Lsp.Lua.Embedded.LuaParserEmbedded luaParser;
    }
}