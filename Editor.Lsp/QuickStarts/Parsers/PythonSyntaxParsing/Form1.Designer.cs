namespace PythonSyntaxParsing
{
    ...
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pythonParser = new Alternet.Syntax.Parsers.Lsp.Python.Embedded.Pyright.PythonParserEmbedded(this.components);
            ...
            this.laDescription.Text = "This demo shows how to use LSP parser for Python language based on Pyls. This par" +
    "ser supports automatic code completion and syntax error underlining.";
            ...
            // pythonParser
            // 
            this.pythonParser.XmlScheme = resources.GetString("pythonParser.XmlScheme");
            // 
            // Form1
            // 
        ...
        private Alternet.Syntax.Parsers.Lsp.Python.Embedded.Pyright.PythonParserEmbedded pythonParser;
    }
}