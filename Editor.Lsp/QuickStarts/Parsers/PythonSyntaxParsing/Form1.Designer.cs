namespace PythonSyntaxParsing
{
    ...
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pythonParser = new Alternet.Syntax.Parsers.Lsp.Python.Embedded.PythonParserEmbedded(this.components);
    ...
    "ser supports automatic code completion and syntax error underlining.";
        ...
        private Alternet.Syntax.Parsers.Lsp.Python.Embedded.PythonParserEmbedded pythonParser;
    }
}