...
namespace Alternet.Scripter.Integration.AlternetUI
{
    public abstract class BaseDebuggerIntegrationPanel : Panel
    {
        ...
        public BaseDebuggerIntegrationPanel()
        {
            ...
            controller.WatchAdded += (s, e) =>
            {
                if (e.Expression is not null && e.Expression != string.Empty)
                {
                    debuggerPanelsTabControl?.Watches?.AddWatch(e.Expression);
        ...
        public bool CanCloseProject() => Project != null && Project.HasProject;

        public bool CanCloseFile() => CodeEditContainer.ActiveEditor != null;

        public bool CanSaveFile() => CodeEditContainer.ActiveEditor != null;
