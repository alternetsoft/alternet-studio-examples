...
namespace Threading
{
    public partial class Form1 : Window
    {
        ...
        private ArrayList bubbleArray = [];
        private ArrayList selArray = [];
        private Random rand = new Random();
        private ArrayList quickArray = [];
        private int step = 3;
        ...
        public Form1()
        {
            ...
            IScriptGlobalItem itmBubbleArray
                = new ScriptGlobalItem("bubbleArray", typeof(ArrayList), bubbleArray);
            IScriptGlobalItem itmSelArray
                = new ScriptGlobalItem("selArray", typeof(ArrayList), selArray);
            IScriptGlobalItem itmQuickArray
                = new ScriptGlobalItem("quickArray", typeof(ArrayList), quickArray);
        ...
        public Task RunMethod(string name)
        {
            ...
            return HandleErrors(() =>
            {
                var result = scriptRun.RunMethodAsync(name, null, new object?[] { token }, token);
                return result;
            });
        }
        ...
        private void PaintArray(AbstractControl sender, Alternet.UI.PaintEventArgs e, ArrayList array)
        {
