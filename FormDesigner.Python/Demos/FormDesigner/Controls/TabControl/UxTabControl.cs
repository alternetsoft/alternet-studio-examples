...
namespace VSControls
{
    ...
    public partial class UxTabControl : TabControl
    {
        ...
        private void DrawCustomTabControl(Graphics g, Rectangle clipRect)
        {
            ...
            // draw page itself
            if (SelectedIndex != -1 && rcPage.IntersectsWith(clipRect))
        ...
        private void DrawTabItem(Graphics g, int index, Rectangle tabRect, VisualStyleRenderer rend)
        {
            ...
            using (GdiMemoryContext memGdi = new GdiMemoryContext(g, tabRect.Width, tabRect.Height))
            {
                ...
                // drawing tab text
                TextRenderer.DrawText(memGdi.Graphics, pg.Text, this.Font, drawRect, rend.GetColor(ColorProperty.TextColor), TextFormatFlags.SingleLine | TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter);
