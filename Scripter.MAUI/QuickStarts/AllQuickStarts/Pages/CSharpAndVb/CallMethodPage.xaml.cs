...
public partial class CallMethodPage : DemoPage
{
    ...
    public CallMethodPage()
    {
        ...
        csParser1?.Repository.RegisterDefaultAssemblies(TechnologyEnvironment.System);
        vbParser1?.Repository.RegisterDefaultAssemblies(TechnologyEnvironment.System);
