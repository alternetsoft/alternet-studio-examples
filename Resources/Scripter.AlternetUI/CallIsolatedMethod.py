...
def OnPaint(g, bounds):
  global arenaBackgroundBrush
  global dotBrush
...
def OnUpdate(deltaTimeMs):
  global currentAngle
  currentAngle = currentAngle + deltaTimeMs * 0.1
  currentAngle = ConstrainAngle(currentAngle)
  MyObject.UpdateCurrentAngle(currentAngle)
