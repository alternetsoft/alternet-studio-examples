    ...
    public partial class MainForm : IDebuggerUICommands
    {
        ...
        private void EvaluateExpression(bool evaluateCurrentException = false)
        {
            ...
            using (var dialog = new EvaluateDialog(
                EvaluateDialog.CodeCompletionOptions.Disabled)
            {
                Debugger = Debugger,
            ...
            })
            {
                ...
                dialog.WatchAdded += Dialog_WatchAdded;
                dialog.ShowDialog();
            }
        }
        ...
        private void UpdateDebugButtons()
        {
            ...
            var hasProject = Project.HasProject;
        ...
        {
            if (executionPosition != null && !string.IsNullOrEmpty(executionPosition.File))
            {
