...
namespace Customize.Dialogs
{
    ...
    public interface ISyntaxSettings : IPersistentSettings
    {
        ...
        /// <summary>
        /// When implemented by a class, gets or sets options for navigating within
        /// <c>SyntaxEdit</c> controls content.
        /// </summary>
        ...
        /// <summary>
        /// When implemented by a class, gets or sets options determining appearance
        /// and behavior of the <c>Selection</c> object in <c>SyntaxEdit</c> controls.
        /// </summary>
        ...
        /// <summary>
        /// When implemented by a class, gets or sets a gutter options that determines
        /// <c>Gutter</c> appearance and behavior for <c>SyntaxEdit</c> controls.
        /// </summary>
        ...
        /// the <c>Margin</c> is visible in <c>SyntaxEdit</c> controls.
        /// </summary>
        bool ShowMargin
        {
            get;
        ...
        /// <summary>
        /// When implemented by a class, gets or sets a value indicating whether
        /// the <c>Gutter</c> is visible in <c>SyntaxEdit</c> controls.
        /// </summary>
        bool ShowGutter
        {
            get;
        ...
        /// <summary>
        /// When implemented by a class, gets or sets a value indicating whether
        /// urls in the <c>SyntaxEdit</c> controls text should be highlighted.
        /// </summary>
        ...
        /// <summary>
        /// When implemented by a class, gets or sets a value indicating whether
        /// outlining is enabled for <c>SyntaxEdit</c> controls.
        /// </summary>
        bool AllowOutlining
        {
            get;
        ...
        /// <summary>
        /// When implemented by a class, gets or sets a value indicating whether
        /// indent operations insert space characters rather than TAB characters
        /// in <c>SyntaxEdit</c> controls.
        /// </summary>
        bool UseSpaces
        {
            get;
        ...
        /// <summary>
        /// When implemented by a class, gets or sets a value indicating whether
        /// <c>SyntaxEdit</c> controls automatically wrap words to the beginning
        ...
        /// <summary>
        /// When implemented by a class, gets or sets the width of
        /// the <c>Gutter</c> for <c>SyntaxEdit</c> controls.
        /// </summary>
        int GutterWidth
        {
            get;
        ...
        /// <summary>
        /// When implemented by a class, gets or sets value indicating position,
        /// in characters, of the vertical line within the text portion of
        /// the <c>SyntaxEdit</c> controls.
        /// </summary>
        int MarginPos
        {
            get;
        ...
        /// <summary>
        /// When implemented by a class, gets or sets the character columns
        /// that the cursor will move to each time you press Tab in <c>SyntaxEdit</c> controls.
        /// </summary>
        int[] TabStops
        {
            get;
        ...
        /// <c>ISyntaxSettings</c> accordingly to property values of <c>SyntaxEdit</c> control.
        /// </summary>
        /// <param name="edit">Specifies <c>SyntaxEdit</c> to copy properties from.</param>
        void LoadFromEdit(ISyntaxEdit edit, bool withStyles = false);

        /// <summary>
        /// When implemented by a class, assigns key properties of given
        /// <c>SyntaxEdit</c> according to values stored in the <c>ISyntaxSettings</c> instance.
        /// </summary>
        ...
        /// <summary>
        /// When implemented by a class, indicates whether description for
        /// specified lexical style is enabled.
        /// </summary>
        ...
        /// <summary>
        /// When implemented by a class, indicates whether font style for
        /// specified lexical style is enabled.
        /// </summary>
        /// <param name="index">Specifies index of lexical style to check-up.</param>
        ...
        /// <summary>
        /// When implemented by a class, indicates whether background color
        /// for specified lexical style is enabled.
        /// </summary>
        /// <param name="index">Specifies index of lexical style to check-up.</param>
