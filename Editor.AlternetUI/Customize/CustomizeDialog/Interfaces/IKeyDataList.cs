...
namespace Alternet.Editor.CustomizeDialog.AlternetUI
{
    ...
    {
        /// <summary>
        /// When implemented by a class, gets or sets an xml representation
        /// of this <c>IKeyDataList</c> object.
        /// </summary>
        /// <remarks>Normally, you do not need to use this property directly.
        /// It's used internally when serializing IKeyData content to XML.</remarks>
