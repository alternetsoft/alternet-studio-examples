...
namespace SearchReplace
{
    ...
    public partial class DlgSearchInFiles : Form, IFormDlgSearch
    {
        ...
        private void ResizeControls()
        {
            ...
            btFindNext.Text = StringConsts.FindNextCaption;
            //btFindNext.Left = incremental ? cbFindWhat.Left + cbFindWhat.Width - btFindNext.Width : DefaultFindLocation;
            //btReplace.Left = incremental ? cbFindWhat.Left + cbFindWhat.Width - btReplace.Width : DefaultFindLocation;
