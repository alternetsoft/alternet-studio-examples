namespace AdvancedSyntaxParsing
{
    ...
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.laDescription.Text = @"This demo shows how to link text edit controls to the advanced parsers for subset of programming languages such as C#, VB.NET, JavaScript, XML and others. These parsers support automatic code completion, code outlining, smart formatting and syntax error underlining.";
            ...
            this.Text = "Advanced Syntax Parsing";
