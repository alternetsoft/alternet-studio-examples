...
namespace MultipleView
{
    public partial class Form1 : Form
    {
        ...
        private AlphaImageList buttonsImageList = new AlphaImageList();
        ...
        private AlphaImageList LoadImageList(string resource)
        {
            return AlphaImageListHelper.LoadImageListFromStrip(typeof(Form1).Assembly, string.Format("MultipleView.Resources.{0}.png", resource));
        }
