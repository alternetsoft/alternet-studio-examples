...
namespace Alternet.CodeEditorSyntax.Demo
{
    public class CodeParsing
    {
        ...
        public static void RegisterAssemblies(string extension, string[] references, TechnologyEnvironment technology = TechnologyEnvironment.WindowsForms, bool keepExisting = false)
        {
            var solution = GetSolution(extension);
            if (solution == null)
                return;
        ...
        public static void UnregisterAssemblies(string extension, TechnologyEnvironment technology = TechnologyEnvironment.WindowsForms)
        {
            var solution = GetSolution(extension);
            if (solution == null)
                return;
