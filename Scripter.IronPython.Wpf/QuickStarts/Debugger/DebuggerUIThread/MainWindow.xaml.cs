...
namespace DebuggerUIThread.IronPython.Wpf
{
    public partial class MainWindow : Window
    {
        private static readonly string[] ProjectSearchDirectories = new[] { ".", @"..\..\..\..\..\..\..\" };
        private static readonly string StartupFileSubPath = @"Resources\Debugger.IronPython\DebuggerUIThread\CallMethodWpf.py";
        ...
        private IronPythonParser pythonParser;

        public MainWindow()
        {
            InitializeComponent();
            pythonParser = new IronPythonParser();
