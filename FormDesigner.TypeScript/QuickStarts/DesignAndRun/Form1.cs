...
namespace DesignAndRun
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                var designerFiles = Directory.GetFiles(folder, "*.Designer.ts", SearchOption.AllDirectories);
        ...
        private EditorFormDesignerDataSource GetActiveDesignerSource()
        {
            ...
            if (editor != null)
            {
                ...
                if (extension.Equals("ts", StringComparison.OrdinalIgnoreCase) || extension.Equals("js", StringComparison.OrdinalIgnoreCase))
