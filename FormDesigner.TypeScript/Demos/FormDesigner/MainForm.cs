...
namespace Alternet.FormDesigner.Demo
{
    public partial class MainForm : Form
    {
        ...
        {
            var directory = Path.Combine(Path.GetTempPath(), "Alternet.FormDesigner.TypeScript.Demo", "dotnet-" + Environment.Version.ToString(2));
        ...
        private void OpenDesigner(string fileName)
        {
            ...
            scriptRun.ScriptHost.HostItemsConfiguration.AddAssemblies("core", designer.ReferencedAssemblies.AssemblyNames);
        ...
        private EditorFormDesignerDataSource GetActiveDesignerSource()
        {
            ...
            if (editor != null)
            {
                ...
                if (extension.Equals("js", StringComparison.OrdinalIgnoreCase) || extension.Equals("ts", StringComparison.OrdinalIgnoreCase))
        ...
        private void CreateNewForm()
        {
            var saveFileDialog = new SaveFileDialog
            {
                ...
                FileName = FindUniqueName("Form", ".ts"),
